class ReservationsController < ApplicationController
  ...
  before_action :set_reservation, only: %i[ show edit update destroy finish_reservation update_passengers 
    send_reservation_updated_email cancel_recurring_reservation add_drivers_later approve_all_recurring edit_long ]
