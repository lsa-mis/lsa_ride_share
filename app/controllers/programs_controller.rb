  ...
  private
    ...
    def program_params
      params.require(:program).permit(:active, :title, :term_start, :term_end, :term_id, :subject, :catalog_number, :class_section, 
                                     ...
                                     :non_uofm_passengers, :instructor_id, :admin_access_id, :mvr_link, :canvas_link, :canvas_course_id, 
                                     :updated_by, :config_questions, :add_managers, instructor_attributes: [:uniqname])
    end
end
