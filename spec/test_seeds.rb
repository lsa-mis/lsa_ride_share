...
terms = Term.create!([
  ...
  {code: "2570", name: "Winter 2026", classes_begin_date: DateTime.new(2026, 1, 1), classes_end_date: DateTime.new(2026, 5, 21)},
  {code: "2580", name: "Spring 2026", classes_begin_date: DateTime.new(2026, 5, 6), classes_end_date: DateTime.new(2026, 8, 15)},
  {code: "2610", name: "Fall 2026", classes_begin_date: DateTime.new(2026, 8, 31), classes_end_date: DateTime.new(2026, 12, 15)}

])

test_unit = Unit.create!(name: "Fake Unit", ldap_group: "fake_group")
