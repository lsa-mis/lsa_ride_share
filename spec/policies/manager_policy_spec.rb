...
RSpec.describe ManagerPolicy, type: :policy do
  ...
  context 'with manager role' do
    ...
    it { is_expected.to forbid_actions(%i[is_super_admin is_admin is_student user_in_access_group index create new update edit edit_program_managers update_managers_mvr_status remove_manager_from_program destroy]) }
  ...
  context 'with student role' do
    ...
    it { is_expected.to forbid_actions(%i[is_super_admin is_admin is_manager user_in_access_group index create new update edit edit_program_managers update_managers_mvr_status remove_manager_from_program destroy]) }
