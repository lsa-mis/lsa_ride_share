...
RSpec.describe VehicleReportPolicy, type: :policy do
  ...
  context 'with super_admin role' do
    subject { described_class.new({ user: user, role: "super_admin", params: {id: vehicle_report.id, reservation_id: reservation_manager.id} }, vehicle_report) }
  ...
  context 'with admin role' do
    subject { described_class.new({ user: user, role: "admin", params: {id: vehicle_report.id, reservation_id: reservation_manager.id} }, vehicle_report) }
  ...
  context 'with no role' do
    subject { described_class.new({ user: user_none, role: "none", params: {id: vehicle_report.id, reservation_id: reservation_manager.id}  }, reservation) }
