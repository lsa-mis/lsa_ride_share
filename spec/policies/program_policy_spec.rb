...
RSpec.describe ProgramPolicy, type: :policy do
  ...
  context 'with manager role' do
    ...
    it { is_expected.to forbid_actions(%i[is_super_admin is_student is_admin user_in_access_group create new]) }
  ...
  context 'with student role' do
    ...
    it { is_expected.to forbid_actions(%i[is_super_admin is_admin is_manager user_in_access_group index show create new update edit duplicate get_programs_list get_students_list get_sites_list]) }
