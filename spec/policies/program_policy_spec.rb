...
RSpec.describe ProgramPolicy, type: :policy do
  ...
  context 'with super_admin role' do
    ...
    it { is_expected.to permit_only_actions(%i[index show create new update edit duplicate get_programs_list get_students_list get_sites_list destroy]) }
  end
  ...
  context 'with manager role' do
    ...
    it { is_expected.to forbid_actions(%i[create new duplicate destroy]) }
  ...
  context 'with student role' do
    ...
    it { is_expected.to forbid_actions(%i[index show create new update edit duplicate get_programs_list get_students_list get_sites_list destroy]) }
